package sms.myunibapp.Constants;

public class FirebaseDb {

    //Collezione Utente per
    public static final String TABLE_STUDENTE = "Studente";

    public static final String USER_AVATAR = "Avatar";
    public static final String USER_NOME = "Nome";
    public static final String USER_COGNOME = "Cognome";
    public static final String USER_MATRICOLA = "Matricola";
    public static final String USER_ANNOREGOLAMENTO = "AnnoDiRegolamento";
